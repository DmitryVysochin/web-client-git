                ...
                <div>
                    <form method="post" action="{{ route("connect.login") }}">
                        <div class="mb-3">
                            ...
                            <input name="ipAddress" type="text" class="form-control" id="exampleInputIP" aria-describedby="ipHelp" required>
                            <div id="ipHelp" class="form-text">Введите в формате 127.0.0.1</div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPort" class="form-label">Порт SSH</label>
                            <input name="port" type="text" class="form-control" id="exampleInputPort" aria-describedby="portHelp">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="path" type="text" class="form-control" id="exampleInputPath" required>
                        </div>
